...
// This file is VESC-specific, meaning we do not care too much about generalization here
...
// TODO: why use motorsim in differential steering?
	...
	for(;;) {
		...
		while (rx_frame_read != rx_frame_write) {
			...
			if (rxmsg.IDE == CAN_IDE_EXT) {
				...
				// TODO: readd io_board and possibly dw board
			}
